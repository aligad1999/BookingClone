...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <a class="navbar-brand" href="#">Hotel<span style="color: #28a745">Reservation</span>System </a>
        ...
        <div class="bg-img">
            ...
            <form class="form-inline check-date-form-container" onsubmit="return checkForms();" action="Search" method="POST">


                <div class="form-group mx-sm-3 mb-2">
                    <label class="check-lbl">Destination</label>
                    <input type="text" name="cityName" placeholder="Destination">
                </div>
                ...
                <div class="form-group mx-sm-3 mb-2">
                    <label class="check-lbl">Adults</label>
                    <input type="number" name="numAdults" min='0' placeholder="Adults">
                </div>

                <div class="form-group mx-sm-3 mb-2">
                    <label class="check-lbl">Children</label>
                    <input type="number" name="numChildren" min='0' placeholder="Children">
                </div>


                <div class="form-group mx-sm-3 mb-2">
                    <label class="check-lbl">Rooms</label>
                    <input type="number" name="numRooms" min='0' placeholder="Rooms">
                </div>
